...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Developing the frontend for Etiqa\'s insurance website in the Philippines. Building Vue components and integrating REST APIs to display CMS-managed content including insurance products, FAQs, and landing pages. Currently in progress.',
  ...
  },
  {
    ...
    description: 'Developing the frontend for Etiqa\'s online insurance shop where users can browse and purchase insurance products. Integrating REST APIs for product listings and checkout flows driven by a CMS backend. Currently in progress.',
